...
#mingo_working<- mingo %>% 
 ...
 # reporter_state = "WV"	~ "in_state_disribution",
...
#manufacturer (labeler) - distributor (reporter)- pharmacy (buyer) - responsbile for largest number of pills being shipped to Mingo County, WV 
...
# Actavis Pharma , Inc. - > Miami Luken,->  Tug Valley Pharmacy, LLC with 4954200 pills 
...
# I am unsure how to do this but I thin it might be a funciton case wehn() and then multi-case if_else(), basically try to combine varibale into one and then create a new column, where all the cardinals are merged into one variable. 
